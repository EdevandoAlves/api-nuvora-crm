...
export class CreateInitialSchema1761780311098 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "deal_product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "dealId" uuid NOT NULL, "productId" uuid NOT NULL, "quantity" integer NOT NULL, "unitPrice" numeric(15,2) NOT NULL, "discount" numeric(5,2) NOT NULL DEFAULT '0', "totalPrice" numeric(15,2) NOT NULL, CONSTRAINT "PK_a76c368ef4373c0b58996a1ff6a" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."task_type_enum" AS ENUM('CALL', 'EMAIL', 'FOLLOW_UP', 'DEMO', 'PROPOSAL', 'MEETING')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."task_priority_enum" AS ENUM('LOW', 'MEDIUM', 'HIGH')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."task_status_enum" AS ENUM('PENDING', 'COMPLETED', 'CANCELLED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."deal_stage_enum" AS ENUM('QUALIFICATION', 'PROPOSAL', 'NEGOTIATION', 'CLOSED_WON', 'CLOSED_LOST')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."customer_status_enum" AS ENUM('LEAD', 'PROSPECT', 'CUSTOMER', 'CHURNED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."organization_plan_enum" AS ENUM('FREE', 'BASIC', 'PRO', 'ENTERPRISE')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."user_role_enum" AS ENUM('OWNER', 'ADMIN', 'MANAGER', 'SALES', 'SUPPORT')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "interaction" ADD CONSTRAINT "FK_853a393053bb95521f8a89d3e25" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "interaction" ADD CONSTRAINT "FK_6680a4d595bf89fc94984065e0b" FOREIGN KEY ("customerId") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "interaction" ADD CONSTRAINT "FK_61f111fef7c98e6c82d3cde3a89" FOREIGN KEY ("contactId") REFERENCES "contact"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "interaction" ADD CONSTRAINT "FK_bfec87b7d90c185221bb0a4d1df" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "contact" ADD CONSTRAINT "FK_a54f4088bd2e596cc15c1f7aa3d" FOREIGN KEY ("customerId") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD CONSTRAINT "FK_32a4bdd261ec81f4ca6b3abe262" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "deal_product" ADD CONSTRAINT "FK_57a28f48ef6ca650bce402b6a55" FOREIGN KEY ("dealId") REFERENCES "deal"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "deal_product" ADD CONSTRAINT "FK_98fb00184836d07acf6800f0167" FOREIGN KEY ("productId") REFERENCES "product"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "task" ADD CONSTRAINT "FK_5b0272d923a31c972bed1a1ac4d" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "task" ADD CONSTRAINT "FK_2997f01b00a9dc7d7fec2db89ae" FOREIGN KEY ("customerId") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "task" ADD CONSTRAINT "FK_62925237e1b92cf37c6079a334c" FOREIGN KEY ("dealId") REFERENCES "deal"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "deal" ADD CONSTRAINT "FK_38fb85abdf9995efcf217f59554" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "deal" ADD CONSTRAINT "FK_cef8a02fad2477f5391c15d28ff" FOREIGN KEY ("customerId") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "deal" ADD CONSTRAINT "FK_e67171307cc9b77c84c02cc2a1e" FOREIGN KEY ("ownerId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "customer" ADD CONSTRAINT "FK_6dd837492f09ba0c61324532fee" FOREIGN KEY ("organizationId") REFERENCES "organization"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "customer" ADD CONSTRAINT "FK_a95e40a440dd90f0501baf50ca4" FOREIGN KEY ("ownerId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "customer" DROP CONSTRAINT "FK_a95e40a440dd90f0501baf50ca4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "customer" DROP CONSTRAINT "FK_6dd837492f09ba0c61324532fee"`,
    );
    await queryRunner.query(
      `ALTER TABLE "deal" DROP CONSTRAINT "FK_e67171307cc9b77c84c02cc2a1e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "deal" DROP CONSTRAINT "FK_cef8a02fad2477f5391c15d28ff"`,
    );
    await queryRunner.query(
      `ALTER TABLE "deal" DROP CONSTRAINT "FK_38fb85abdf9995efcf217f59554"`,
    );
    await queryRunner.query(
      `ALTER TABLE "task" DROP CONSTRAINT "FK_62925237e1b92cf37c6079a334c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "task" DROP CONSTRAINT "FK_2997f01b00a9dc7d7fec2db89ae"`,
    );
    await queryRunner.query(
      `ALTER TABLE "task" DROP CONSTRAINT "FK_f316d3fe53497d4d8a2957db8b9"`,
    );
    await queryRunner.query(
      `ALTER TABLE "task" DROP CONSTRAINT "FK_5b0272d923a31c972bed1a1ac4d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "deal_product" DROP CONSTRAINT "FK_98fb00184836d07acf6800f0167"`,
    );
    await queryRunner.query(
      `ALTER TABLE "deal_product" DROP CONSTRAINT "FK_57a28f48ef6ca650bce402b6a55"`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" DROP CONSTRAINT "FK_32a4bdd261ec81f4ca6b3abe262"`,
    );
    await queryRunner.query(
      `ALTER TABLE "contact" DROP CONSTRAINT "FK_a54f4088bd2e596cc15c1f7aa3d"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "interaction" DROP CONSTRAINT "FK_61f111fef7c98e6c82d3cde3a89"`,
    );
    await queryRunner.query(
      `ALTER TABLE "interaction" DROP CONSTRAINT "FK_6680a4d595bf89fc94984065e0b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "interaction" DROP CONSTRAINT "FK_853a393053bb95521f8a89d3e25"`,
    );
